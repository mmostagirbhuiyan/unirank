# Ranking Aggregation Guide 📊

**Detailed explanation of the Borda Count methodology used in `scripts/aggregation.js`**

---

## 📋 Overview

The `scripts/aggregation.js` script is the central orchestrator of the university ranking aggregation process. It performs the following key functions:
...
[🏠 Home](../README.md) · [🛠️ Automation Workflow](AUTOMATION_WORKFLOW_GUIDE.md) · [🎯 Mapping Tools](MAPPING_TOOLS_GUIDE.md) · [⚙️ Scrape Rankings](SCRAPE_RANKINGS_GUIDE.md)

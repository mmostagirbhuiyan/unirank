    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <main className="relative z-10 container mx-auto px-4 sm:px-6 py-12">
        ...
        <section className="sticky top-20 z-20 mb-8">
          <div className="bg-muted/60 backdrop-blur-xl border border-border shadow-lg rounded-2xl p-2 flex flex-col md:flex-row gap-2 transition-all">
            <div className="relative flex-grow">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground w-5 h-5" />
              <input
                type="text"
                placeholder="Search by name..."
                className="w-full bg-background text-foreground pl-12 pr-4 py-3 rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all placeholder:text-muted-foreground/70"
                value={searchTerm}
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0">
              <select
                className="bg-background text-foreground px-4 py-3 rounded-xl border border-border outline-none focus:border-primary appearance-none min-w-[160px]"
                value={sortBy}
              ...
              <select
                className="bg-background text-foreground px-4 py-3 rounded-xl border border-border outline-none focus:border-primary appearance-none min-w-[140px]"
                value={selectedGroup}
